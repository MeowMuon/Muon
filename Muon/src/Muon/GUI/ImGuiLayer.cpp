...
namespace Muon
{
	...
	void ImGuiLayer::OnEvent(Event& e)
	{
		...
		d.Dispatch<MousePressEvent>(MU_BIND_1P(ImGuiLayer::OnMouseButtonPress, this));
		d.Dispatch<MouseReleaseEvent>(MU_BIND_1P(ImGuiLayer::OnMouseButtonRelease, this));
		d.Dispatch<MouseScrollEvent>(MU_BIND_1P(ImGuiLayer::OnMouseScroll, this));
		d.Dispatch<KeyPressEvent>(MU_BIND_1P(ImGuiLayer::OnKeyPress, this));
		d.Dispatch<KeyReleaseEvent>(MU_BIND_1P(ImGuiLayer::OnKeyRelease, this));
		d.Dispatch<KeyTypeEvent>(MU_BIND_1P(ImGuiLayer::OnKeyType, this));
	}

	static ImGuiKey KeyMap(int key);
	...
	bool ImGuiLayer::OnKeyType(KeyTypeEvent& e)
	{
		...
		if (key_code > 0 && key_code < 0x10000)
			io.AddInputCharacter((char)key_code);
		return false;
	}
